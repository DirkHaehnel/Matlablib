...
len = 1.5*rad;
% Dichroic
surf(-rad*[1;1]*cos(phi), [-sin(phi)*rad; -2.2*height*ones(1,length(phi))], -2*height-rad*[1;1]*sin(phi), 0.6*ones(2,length(phi)), 'facealpha', lighttransparency)
...
surf([0 len], [0 0]-1.5*height, -2*height-[1 1; -1 -1]*len, zeros(2,2),'facealpha', 0.1)
surf([0:len/10:len]', [0 0]-1.5*height, -2*height-[1 1]'*linspace(1,-1,11)*len, zeros(2,11),'facealpha', 0.1)
surf(zeros(2,2), [-1 -1; -1.5 -1.5]*height, -2*height-[1 -1; 1 -1]*len, zeros(2,2),'facealpha', 0.2)
surf([0 0; len len], [-1 -1.5; -1 -1.5]*height, -2*height-[-1 -1; -1 -1]*len, zeros(2,2),'facealpha', 0.3)
