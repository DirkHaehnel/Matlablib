...
[fxc1, fxs1, fyc1, fys1, fzc1, fzs1, rho, z] = GaussExc(rhofield, zfield, NA(1), fd, n0, n, n1, d0, d, d1, lamex, over(1,:), focpos(1,:), atf, resolution, ring(1), maxm);
[fxc2, fxs2, fyc2, fys2, fzc2, fzs2] = GaussExc(rhofield, zfield, NA(1), fd, n0, n, n1, d0, d, d1, lamex, over(2,:), focpos(2,[1 3 2 4 5]).*[1 1 -1 1 1], atf, resolution, ring(1), maxm);
for j=1:maxm
