...
for j=1:mm
    ...
    pdonor(:,j) = Simplex('ExpFun',tau,[1 1],[10 10],[],[],t,donor(:,j),1);
    ...
    pfret(:,j) = Simplex('ExpFun',tau,[1 1],[10 10],[],[],t,fret(:,j),1);
...
text(0.5*(t2-t1),0.7,['FRET efficiency = ' mnum2str(mean(fretE),1,2)])
axis([0 t2-t1 0 1.1])
