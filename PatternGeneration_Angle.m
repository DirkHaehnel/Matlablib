function [im, mask,fxx0,fxx2, fxz, byx0, byx2, byz] = PatternGeneration_Angle(z, NA, n0, n, n1, d0, d, d1, lamem, mag, focus, atf, ring, pixel, nn, be, al, pic)
...
if nargin<16 || isempty(be)
    be = 0; % minimum resolution of in-plane angle
end
if nargin<17 || isempty(al)
    al = pi/2; % minimum resolution of out-of-plane angle
end
