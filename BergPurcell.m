function [dist, flux, rhov, zv, delta, conc] = BergPurcell(N, L, R, rhomax, a, DiffConstant)

% program for the modeling of the Berg & Purcell receptor problem in
% cylindrical coordinates
% input variables:
% N - number of receptors around cylinder
% L - length of cylinder slice per receptor in mum
% R - radius of cylinder in mum
% rhomax - radius of outer boundary in mum
% a - radius of receptor in mum
