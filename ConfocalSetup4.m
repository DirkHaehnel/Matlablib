...
surf(-rad*[1;1]*cos(phi), -rad*[1;1]*sin(phi), [-(d+1)*foc*ones(1,length(phi)); -2*height-rad*sin(phi)], 0.6*ones(2,length(phi)), 'facealpha', lighttransparency)
...
len = 1.5*rad;
% Dichroic
surf(-rad*[1;1]*cos(phi), [-sin(phi)*rad; -height*ones(1,length(phi))], -2*height-rad*[1;1]*sin(phi), 0.6*ones(2,length(phi)), 'facealpha', lighttransparency)
...
surf(-rad*[1;1]*cos(phi), -5*height-rad*[1;1]*sin(phi), [-2*height-rad*sin(phi); -3.5*height*ones(1,length(phi))], 0.2*ones(2,length(phi)), 'facealpha', lighttransparency)
surf(-rad*[1;1]*cos(phi), [-5*height-rad*sin(phi); -6.5*height*ones(1,length(phi))], -2*height-rad*[1;1]*sin(phi), 0.5*ones(2,length(phi)), 'facealpha', lighttransparency)
surf(-rad*[1;1]*cos(phi), [-3*height*ones(1,length(phi)); -5*height-rad*sin(phi)], -2*height-rad*[1;1]*sin(phi), 0.6*ones(2,length(phi)), 'facealpha', lighttransparency)
...
surf([0 len], [0 0]-4*height, -2*height-[1 1; -1 -1]*len, zeros(2,2),'facealpha', 0.1)
surf([0:len/10:len]', [0 0]-4*height, -2*height-[1 1]'*linspace(1,-1,11)*len, zeros(2,11),'facealpha', 0.1)
surf(zeros(2,2), [-3.5 -3.5; -4 -4]*height, -2*height-[1 -1; 1 -1]*len, zeros(2,2),'facealpha', 0.2)
surf([0 0; len len], [-3.5 -4; -3.5 -4]*height, -2*height-[-1 -1; -1 -1]*len, zeros(2,2),'facealpha', 0.3)
