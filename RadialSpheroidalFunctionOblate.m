function [r1f,r1d,r2f,r2d] = RadialSpheroidalFunctionOblate(n,m,c,x,kf)
...
if (kf > 1);
    ...
    if (id > -1);
        [m,n,c,x,cv,df,kd,r2f,r2d]=rmn2so(m,n,c,x,cv,df,kd,r2f,r2d);
    end;
end;
...
function [m,n,c,x,cv,df,kd,r2f,r2d]=rmn2so(m,n,c,x,cv,df,kd,r2f,r2d);
...
[m,n,c,ck,ck1,qs,qt]=qstar(m,n,c,ck,ck1,qs,qt);
[m,n,c,cv,qt,ck,bk]=cbk(m,n,c,cv,qt,ck,bk);
if (x == 0.0d0);
    sum=0.0d0;
    for  j=1:nm;
        sum=sum+ck(j);
    ...
    [m,n,c,x,bk,gf,gd]=gmn(m,n,c,x,bk,gf,gd);
    [m,n,c,x,df,kd,r1f,r1d]=rmn1(m,n,c,x,df,kd,r1f,r1d);
    h0=atan(x)-0.5d0.*pi;
    r2f=qs.*r1f.*h0+gf;
...
function [m,n,c,ck,ck1,qs,qt]=qstar(m,n,c,ck,ck1,qs,qt);
...
function [m,n,c,cv,qt,ck,bk]=cbk(m,n,c,cv,qt,ck,bk);
...
function [m,n,c,x,bk,gf,gd]=gmn(m,n,c,x,bk,gf,gd);
