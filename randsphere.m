...
% INPUT:
%
% N         Desired number of random points
% D         Dimension (default= 3, for the sphere)
% rad       Radius of the sphere [default: 1]
%
% OUTPUT:
%
% x,y,z     Cartesian points on the unit sphere
% lon,lat   Earth coordinates indegrees
%
% Last modified by fjsimons-at-alum.mit.edu, 19.06.2006
